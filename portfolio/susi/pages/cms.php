<?php 
session_start();
//IF LOGGED IN - GET USER INFO FROM DB AND DISPLAY IT , IF NOT - REDIRECT TO MAIN PAGE
if (isset($_SESSION['login'])) {
	include 'bdConnect.php';  
	$dbname = "users";
	$id = $_SESSION['id'];
	$conn = new mysqli($servername, $username, $serverpassword , $dbname);
	$sql = "SELECT * FROM usersforsushi where id ='$id'";
		...
		<table class="table , table-bordered" style=" min-height: 100px; word-break: break-all;">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<button onclick="PopUpS(\'pages/passwordChange.php\')" class="btn btn-danger btn-sm" style="width:100%;">
							Change password 
						</button>
					</td>
				</tr>   
